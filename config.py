...
TITLE_SIGNALS = [
    ...
    "trainer",  # "training" does not substring-match "trainer"; the exact
                # role word in RESUME_TRACKS "EdTech / Training" + the
                # "healthcare IT trainer" search keyword was scoring zero.
